...
var BattleMenu = function (game) {
    ...
    // Battle screen UI background
    this.ui_battle = this.create(-2, 431, 'ui_back_battle');
    this.r_ui_battle = new Phaser.Rectangle(this.ui_battle.x, this.ui_battle.y, this.ui_battle.width, this.ui_battle.height - 180);
    // Pretty scrolling backgrounds
    var back_lines_battle = new LineUI(game, 10, 10, 945, 203);
    back_lines_battle.name = 'back_lines';
    this.ui_battle.addChild(back_lines_battle);


    // Selection arrow
    this.selection_arrow = this.create(20, 456, 'selection_arrow');
    this.selection_arrow.exists = false;


    // Selection boxes
    for (var i = 0; i < 4; i++) {
        this['selection_' + i] = this.create(58, 453 + (i * 40), 'ui_battle_select_box');
    }


    
    // INIT TEXT
    //this.g_extended_stat_text = this.game.add.group();
    ...
    */
    ...
    /*
    this.extended_stat_scroll_bar = this.game.add.sprite(this.ui_inventory_01.x + 446, this.ui_inventory_01.y + 405, 'scroll_bar');
    ...
    this.g_extended_stat_text.add(this.extended_stat_scroll_bar);
    */
};

BattleMenu.prototype = Object.create(Phaser.Group.prototype);
BattleMenu.prototype.constructor = BattleMenu;

/*
BattleMenu.prototype.update = function () {

    if (this.ui_battle.exists) {
        //this.g_extended_stat_text.forEach(this.update_text, this);

        this.back_lines_battle.tilePosition.x -= 1;
        this.back_lines_battle.tilePosition.y += 0.1;
    }
    
}
*/
BattleMenu.prototype.update_text = function (q) {
...
BattleMenu.prototype.update_momentum = function (q) {
    if (q instanceof Phaser.Group)
        q.y -= this.momentum_y;
    else
...
BattleMenu.prototype.stop_momentum = function (q) {
...
BattleMenu.prototype.INIT_TEXT = function () {

    this.menu_text = { font: '30px DejaVu Sans Mono', fill: "#69F1F1", align: "center" };
...
BattleMenu.prototype.init_extended_stat_text = function (name, text, index, x, y, style) {
...
BattleMenu.prototype.init_extended_stat_line = function (start_x, start_y, to_x, to_y, line) {
...
BattleMenu.prototype.set_extended_stat_data = function (extended_stat_group) {
...
BattleMenu.prototype.init_tweens = function (obj) {
...
BattleMenu.prototype.set_slot_tweens = function (q) {
...
BattleMenu.prototype.SET_common_tweens = function (obj, amt, is_scroll_bar) {
...
BattleMenu.prototype.SET_tween = function (obj, tween_name, amt, callback, starting_outside, tween_type) {
...
BattleMenu.prototype.SET_tween_scroll = function (obj, tween_name, amt) {
    obj[tween_name] = game.add.tween(obj);
    obj[tween_name].to({ y: obj.y + amt }, 500, Phaser.Easing.Quadratic.Out);
    obj[tween_name].onComplete.add(this.scroll_complete, this);
}
BattleMenu.prototype.SET_tween_fade = function (obj, tween_name, amt, tween_type) {
    obj[tween_name] = game.add.tween(obj);
    obj[tween_name].to({ alpha: amt }, 300, tween_type);
}


BattleMenu.prototype.scroll = function (dir) {
...
BattleMenu.prototype.scroll_up = function () {

    this.scroll('up');
}
BattleMenu.prototype.scroll_down = function () {

    this.scroll('down');
}

//Called on every child of BattleMenu when Inventory button pressed
BattleMenu.prototype.enter_screen = function (obj) {
...
BattleMenu.prototype.exit_screen = function (obj) {
...
BattleMenu.prototype.start_scroll_tween_up = function (obj) {
...
BattleMenu.prototype.start_scroll_tween_down = function (obj) {
...
BattleMenu.prototype.enter_complete = function (obj) {
...
BattleMenu.prototype.r_slot_reset = function (q) {

    q.r_slot.x = this.inv_slots.g_slot.getAt(q.index).open_inventory_x;
}
BattleMenu.prototype.exit_complete = function (obj) {
...
BattleMenu.prototype.scroll_complete = function (obj) {
    ...
    obj.tween_scroll_up = game.add.tween(obj);
    ...
    obj.tween_scroll_down = game.add.tween(obj);
...
BattleMenu.prototype.color_change_above_base_stats = function () {
