...
Phaser.BitmapData.prototype = {
    ...
    */
    drawGroup: function (group, blendMode, roundPx) {
        ...
        if (group instanceof Phaser.BitmapText) 
        {
            for(var o = 0; o < group.children.length; o++) {

                this.copy(group.children[o], 0, 0, null, null, group.x + group.children[o].x, group.y + group.children[o].y);
            }
        } 
        else 
        {
            for(var i = 0; i < group.children.length; i++) {
                ...
                for(var e = 0; e < group.children[i].children.length; e++) {

                    this.copy(group.children[i].children[e], 0, 0, null, null, group.children[i].x + group.children[i].children[e].x, group.children[i].y + group.children[i].children[e].y);
                }
            }
        }

        //group.forEach(this.copy, this, null, null, null, null, null, null, null, null, null, null, null, null, null, null, blendMode, roundPx);
