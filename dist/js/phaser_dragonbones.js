        ...
        var PhaserDisplayBridge = (function () {
            ...
            PhaserDisplayBridge.prototype.setDisplay = function (value) {
                ...
                if (this._display) {
                    ...
                    if (parent) {
                        // **** CHANGED TO BELOW ***** var index = this._display.parent.*getChildIndex*(this._display)                        
                        var index = this._display.parent.getIndex(this._display)
                    }
                    this.removeDisplay()
                }
                this._display = value;
            ...
            PhaserDisplayBridge.prototype.updateTransform = function (matrix, transform) {
                ...
                this._display.scale.setTo(transform.scaleX, transform.scaleY);
            };
